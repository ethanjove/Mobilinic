...
@class TKListViewCellAppearBehavior;
@class TKListViewLayout;
 ...
 */
NSString *const TKListViewElementKindSectionHeader;

/**
 This constant takes place in dequeing supplementary views for group footers.
 */
NSString *const TKListViewElementKindSectionFooter;

/**
 @enum TKListViewScrollDirection
 @discussion Defines the scroll direction of TKListView.
 */
...
/**
 Returns the number of sections that is displayed in TKListView.
 @param listView The TKListView instance requesting the cell.
 */
...
/**
 Defines how the cell are animated when entering the view port.
*/
@property (nonatomic, strong) TKListViewCellAppearBehavior* cellAppearBehavior;
 ...
 */
@property (nonatomic, strong) TKListViewLayout *layout;

/**
 Defines the scroll direction. Affects only wrap layout. Does not affect columns layout.
*/
@property (nonatomic) TKListViewScrollDirection scrollDirection;

/**
 TKListView content insets relative to its view size.
 */
