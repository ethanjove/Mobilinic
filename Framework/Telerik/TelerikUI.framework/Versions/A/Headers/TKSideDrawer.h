...
/**
 The UIViewController that TKSideDrawer is attached to.
 */
 ...
 */
+ (TKSideDrawer *)findSideDrawerForViewController:(UIViewController *)viewController;

/**
 Creates a TKSideDrawer instance and sets its host view.
 @param hostview TKSideDrawer's hostview.
 */
- (id)initWithHostview:(UIView *)hostview;

/**
 Creates a TKSideDrawer instance and attaches it to a view controller.
 @param viewController The UIViewController TKSideDrawer will be attached to.
 @param hostview TKSideDrawer's hostview.
 */
- (id)initWithViewController:(UIViewController *)viewController hostview:(UIView *)hostview;
...
/**
 ...
 @return An array that contains all sections in TKSideDrawer.
 */
- (NSArray *)sections;
...
/**
 ...
 @param itemIndex The index of the selected item in its section.
 @param sectionIndex The index of the section which item is selected.
 */
- (void)sideDrawer:(TKSideDrawer *)sideDrawer didSelectItem:(NSInteger)itemIndex inSection:(NSInteger)sectionIndex;
...
/**
 ...
 @param itemIndex The index of the item in its section.
 @param sectionIndex The index of the item's section inside TKSideDrawer.
 @return The height of the specified item.
 */
- (CGFloat)sideDrawer:(TKSideDrawer *)sideDrawer heightForItem:(NSInteger)itemIndex inSection:(NSInteger)sectionIndex;
...
/**
 ...
 @param sectionIndex The index of the section that contains the item.
 */
...
/**
 ...
 @param itemIndex The index of the item that the cell visualizes.
 @param sectionIndex The index of the section that contains the item.
 */
- (TKSideDrawerTableViewCell *)sideDrawer:(TKSideDrawer *)sideDrawer cellForItem:(NSInteger)itemIndex inSection:(NSInteger)sectionIndex;
...
{
    return [TKSideDrawer findSideDrawerForViewController:self];
}
